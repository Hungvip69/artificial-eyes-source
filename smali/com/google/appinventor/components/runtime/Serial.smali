...
.method public ReadSerial()Ljava/lang/String;
    ...
    invoke-virtual {v2, v1}, Lcom/physicaloid/lib/Physicaloid;->read([B)I
    ...
    .line 91
    .local v2, "mEr":Ljava/io/UnsupportedEncodingException;
    ...
    .line 95
    .end local v1    # "buf":[B
    .end local v2    # "mEr":Ljava/io/UnsupportedEncodingException;
    :cond_1
    :goto_0
    return-object v0
.end method
