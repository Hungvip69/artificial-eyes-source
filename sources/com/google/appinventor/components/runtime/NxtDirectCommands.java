            ...
            try {
                ...
                try {
                    ...
                    if (destination.endsWith(".rxe") || destination.endsWith(".ric")) {
                        numOpenWriteLinear = openWriteLinear("DownloadFile", destination, fileSize);
                    } else {
                        numOpenWriteLinear = openWrite("DownloadFile", destination, fileSize);
                    }
                    Integer handle = numOpenWriteLinear;
                    if (handle == null) {
                        return;
                    }
                    try {
