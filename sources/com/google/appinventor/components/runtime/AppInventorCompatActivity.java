...
public class AppInventorCompatActivity extends Activity implements AppCompatCallback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (Build.VERSION.SDK_INT >= 35) {
            ViewCompat.setOnApplyWindowInsetsListener(getWindow().getDecorView(), new OnApplyWindowInsetsListener() { // from class: com.google.appinventor.components.runtime.AppInventorCompatActivity$$ExternalSyntheticLambda0
                @Override // androidx.core.view.OnApplyWindowInsetsListener
                public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                    return this.f$0.m35lambda$onCreate$0$comgoogleappinventorcomponentsruntimeAppInventorCompatActivity(view, windowInsetsCompat);
                }
            });
        }
    ...
    /* JADX INFO: renamed from: lambda$onCreate$0$com-google-appinventor-components-runtime-AppInventorCompatActivity, reason: not valid java name */
    /* synthetic */ WindowInsetsCompat m35lambda$onCreate$0$comgoogleappinventorcomponentsruntimeAppInventorCompatActivity(View v, WindowInsetsCompat windowInsets) {
    ...
    public ActionBar getSupportActionBar() {
        ...
        try {
            return this.appCompatDelegate != null ? this.appCompatDelegate.getSupportActionBar() : null;
