...
class ZipEntryReader {
    ...
    static ZipEntry readEntry(ByteBuffer in) throws IOException {
        ...
        int compressionMethod2 = in.getShort() & 65535;
        ...
        String name = new String(nameBytes, 0, nameLength2, UTF_8);
        ZipEntry entry = new ZipEntry(name);
        entry.setMethod(compressionMethod2);
        ...
        if (extraLength > 0) {
            ...
            in.get(extra, compressionMethod, extraLength);
