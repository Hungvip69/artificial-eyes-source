...
final class MultiDexExtractor {
    ...
    static List<File> load(Context context, ApplicationInfo applicationInfo, File dexDir, boolean forceReload) throws Throwable {
        List<File> files;
    ...
    private static List<File> performExtractions(File sourceApk, File dexDir) throws Throwable {
        Throwable th;
        File file = dexDir;
        String extractedFilePrefix = sourceApk.getName() + EXTRACTED_NAME_EXT;
