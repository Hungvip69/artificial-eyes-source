            ...
            this.threadRunner.execute(new Runnable() { // from class: com.google.appinventor.components.runtime.ChartData2D.1
                ...
                public void run() {
                    try {
                        ...
                        YailList labelList = ((Chart) ChartData2D.this.container).Labels();
                        int indexList = labelList.indexOf(x);
                        if (indexList > -1) {
                            pair = YailList.makeList(Arrays.asList(Integer.valueOf(indexList), y));
                        }
            ...
            this.threadRunner.execute(new Runnable() { // from class: com.google.appinventor.components.runtime.ChartData2D.2
                ...
                public void run() {
                    try {
                        ...
                        Entry currEntry = ((ChartDataModel) ChartData2D.this.dataModel).getEntryFromTuple(pair);
