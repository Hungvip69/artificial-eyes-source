...
public class ReplForm extends Form {
    ...
    private static final String PROJECTS_ACTIVITY_CLASS = ProjectsActivity.class.getName();
    ...
    private boolean inAppLibrary = false;
    private ArrayList<String> libraryScreens = new ArrayList<>();
    ...
    protected void startNewForm(String nextFormName, Object startupValue) {
        ...
        if (this.inAppLibrary) {
            this.libraryScreens.add(0, this.formName);
    ...
    protected void closeForm(Intent resultIntent) {
        if (this.inAppLibrary) {
            if (!this.libraryScreens.isEmpty()) {
                String newScreen = this.libraryScreens.remove(0);
    ...
    public void addStartCacheButton(Menu menu) {
        MenuItem startCacheItem = menu.add(0, 0, 3, "Save Project").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() { // from class: com.google.appinventor.components.runtime.ReplForm.5
            @Override // android.view.MenuItem.OnMenuItemClickListener
            public boolean onMenuItemClick(MenuItem item) {
        ...
        startCacheItem.setIcon(R.drawable.sym_def_app_icon);
    }

    public void addProjectsButton(Menu menu) {
        MenuItem addProjectsItem = menu.add(0, 0, 3, "Load Project").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() { // from class: com.google.appinventor.components.runtime.ReplForm.6
            @Override // android.view.MenuItem.OnMenuItemClickListener
            public boolean onMenuItemClick(MenuItem item) {
                Intent projectsIntent = new Intent("android.intent.action.MAIN");
                projectsIntent.setClassName(Form.activeForm.$context(), ReplForm.PROJECTS_ACTIVITY_CLASS);
                Form.activeForm.$context().startActivity(projectsIntent);
                return true;
            }
        });
        addProjectsItem.setIcon(R.drawable.sym_def_app_icon);
    }
    ...
    public void addLogcatButton(Menu menu) {
        ...
        MenuItem showSettingsItem = menu.add(0, 0, 4, "Send Error Report").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() { // from class: com.google.appinventor.components.runtime.ReplForm.7
            @Override // android.view.MenuItem.OnMenuItemClickListener
            public boolean onMenuItemClick(MenuItem item) {
