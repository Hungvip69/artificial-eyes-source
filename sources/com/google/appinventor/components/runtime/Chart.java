...
public class Chart extends AndroidViewComponent implements ComponentContainer, OnInitializeListener {
    ...
    private final android.widget.RelativeLayout view;
    ...
    public Chart(ComponentContainer container) {
        super(container);
        this.tick = 1;
        this.view = new android.widget.RelativeLayout(container.$context());
        container.$add(this);
    ...
    public void ValueFormat(int valueType) {
        ...
        if (this.chartView instanceof AxisChartView) {
            ((AxisChartView) this.chartView).setValueType(valueType);
        }
        for (ChartComponent dataComponent : this.dataComponents) {
