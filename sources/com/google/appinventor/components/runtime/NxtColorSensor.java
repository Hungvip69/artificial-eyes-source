...
public class NxtColorSensor extends LegoMindstormsNxtSensor implements Deleteable {
    ...
    static {
        ...
        java.util.Map<Integer, NxtSensorType> map = mapColorToSensorType;
        Integer numValueOf = Integer.valueOf(Component.COLOR_GREEN);
        map.put(numValueOf, NxtSensorType.ColorGreen);
        java.util.Map<Integer, NxtSensorType> map2 = mapColorToSensorType;
        Integer numValueOf2 = Integer.valueOf(Component.COLOR_BLUE);
        map2.put(numValueOf2, NxtSensorType.ColorBlue);
        ...
        mapSensorValueToColor.put(2, numValueOf2);
        mapSensorValueToColor.put(3, numValueOf);
