...
public class CloudDB extends AndroidNonvisibleComponent implements Component, OnClearListener, OnDestroyListener, ObservableDataSource<String, Future<YailList>> {
                ...
                try {
                    ...
                    if (kickit) {
                        this.background.submit(new Runnable() { // from class: com.google.appinventor.components.runtime.CloudDB.2
                            /* JADX INFO: Thrown type has an unknown type hierarchy: redis.clients.jedis.exceptions.JedisException */
    ...
    public void FirstRemoved(Object value) throws JSONException {
        checkProjectIDNotBlank();
        if (value != null) {
            try {
    ...
    public void AppendValueToList(final String tag, Object itemToAdd) throws JSONException {
        checkProjectIDNotBlank();
    ...
    @SimpleEvent
    public void GotValue(String tag, Object value) throws JSONException {
        checkProjectIDNotBlank();
        if (value == null) {
