...
public class ListViewArrayAdapterImageTwoText {
    ...
    public void setImage(ImageView imageView, String imagePath) throws IOException {
    ...
    public ArrayAdapter<YailDictionary> createAdapter() {
        this.itemAdapter = new ArrayAdapter<YailDictionary>(this.container.$context(), R.layout.simple_list_item_2, R.id.text1, this.currentItems) { // from class: com.google.appinventor.components.runtime.util.ListViewArrayAdapterImageTwoText.2
