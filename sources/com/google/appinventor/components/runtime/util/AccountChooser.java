...
public class AccountChooser {
    ...
    public Account findAccount() throws InterruptedException {
        Account account;
    ...
    private String createAccount() {
        ...
        AccountManagerFuture<Bundle> future = this.accountManager.addAccount("com.google", this.service, null, null, this.activity, null, null);
        try {
    ...
    private String selectAccount(Account[] accounts) throws InterruptedException {
