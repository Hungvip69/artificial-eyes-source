...
class NativeOpenStreetMapController implements MapFactory.MapController, MapListener {
    ...
    private static final ITileSource OSM_ROAD_TILE_SOURCE = new XYTileSource("OSM-Road", 1, 20, 256, ".png", new String[]{"https://a.tile.openstreetmap.org/", "https://b.tile.openstreetmap.org/", "https://c.tile.openstreetmap.org/"}, "© OpenStreetMap contributors");
    ...
    private ITileSource getCustomTileSource() {
        return new XYTileSource("Custom", 1, 20, 256, "", new String[]{this.customUrl}) { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.2
    ...
    public void setMapTypeAbstract(MapType type) {
        ...
        switch (type) {
            case Road:
                this.view.setTileSource(OSM_ROAD_TILE_SOURCE);
                break;
            case Aerial:
    ...
    public void setCompassEnabled(boolean enabled) {
        if (enabled && this.compass == null) {
            ...
            this.view.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.3
    ...
    public void addFeature(final MapFactory.MapMarker aiMarker) {
        createNativeMarker(aiMarker, new AsyncCallbackPair<Marker>() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.4
            ...
            public void onSuccess(Marker overlay) {
                overlay.setOnMarkerClickListener(new Marker.OnMarkerClickListener() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.4.1
                ...
                overlay.setOnMarkerDragListener(new Marker.OnMarkerDragListener() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.4.2
    ...
    public void addFeature(final MapFactory.MapLineString aiPolyline) {
        OverlayWithIW overlayWithIWCreateNativePolyline = createNativePolyline(aiPolyline);
        this.featureOverlays.put(aiPolyline, overlayWithIWCreateNativePolyline);
        overlayWithIWCreateNativePolyline.setOnClickListener(new Polyline.OnClickListener() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.5
        ...
        overlayWithIWCreateNativePolyline.setOnDragListener(new Polyline.OnDragListener() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.6
        ...
        if (aiPolyline.Visible()) {
            showOverlay(overlayWithIWCreateNativePolyline);
        } else {
            hideOverlay(overlayWithIWCreateNativePolyline);
        }
    }
    ...
    private void configurePolygon(final MapFactory.MapFeature component, Polygon polygon) {
        ...
        polygon.setOnClickListener(new Polygon.OnClickListener() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.7
        ...
        polygon.setOnDragListener(new Polygon.OnDragListener() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.8
            ...
            public void onDragEnd(Polygon polygon2) {
                if (!(component instanceof MapFactory.MapCircle)) {
                    if (component instanceof MapFactory.MapRectangle) {
                        double north = -90.0d;
                        double east = -180.0d;
                        double west = 180.0d;
                        double south = 90.0d;
    ...
    public void updateFeatureStroke(final MapFactory.HasStroke aiFeature) {
        ...
        overlay.accept(new OverlayWithIWVisitor() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.10
            public void visit(final Marker marker) {
                NativeOpenStreetMapController.this.getMarkerDrawable((MapFactory.MapMarker) aiFeature, new AsyncCallbackPair<Drawable>() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.10.1
                    @Override // com.google.appinventor.components.runtime.util.AsyncCallbackPair
                    public void onFailure(String message) {
    ...
    public void updateFeatureSize(MapFactory.MapMarker aiMarker) {
        ...
        getMarkerDrawable(aiMarker, new AsyncCallbackPair<Drawable>() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.12
            @Override // com.google.appinventor.components.runtime.util.AsyncCallbackPair
            public void onFailure(String message) {
    ...
    private void getMarkerDrawableRaster(final MapFactory.MapMarker aiMarker, final AsyncCallbackPair<Drawable> callback) {
        MediaUtil.getBitmapDrawableAsync(this.form, aiMarker.ImageAsset(), aiMarker.Width(), aiMarker.Height(), new AsyncCallbackPair<BitmapDrawable>() { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.13
            @Override // com.google.appinventor.components.runtime.util.AsyncCallbackPair
            public void onFailure(String message) {
    ...
    private void createNativeMarker(MapFactory.MapMarker aiMarker, AsyncCallbackPair<Marker> callback) {
        ...
        getMarkerDrawable(aiMarker, new AsyncCallbackFacade<Drawable, Marker>(callback) { // from class: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController.14
            ...
            public void onSuccess(Drawable drawable) {
                ...
                this.callback.onSuccess((T) marker);
            }
        });
    }
    ...
    /* JADX INFO: renamed from: com.google.appinventor.components.runtime.util.NativeOpenStreetMapController$15, reason: invalid class name */
