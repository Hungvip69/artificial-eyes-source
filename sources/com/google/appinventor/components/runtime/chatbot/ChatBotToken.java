...
public final class ChatBotToken {
    ...
    public static final class unsigned extends GeneratedMessageV3 implements unsignedOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements unsignedOrBuilder {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ...
                try {
                    try {
                        parsedMessage = unsigned.PARSER.parsePartialFrom(input, extensionRegistry);
                        return this;
                    } catch (InvalidProtocolBufferException e) {
    ...
    public static final class token extends GeneratedMessageV3 implements tokenOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements tokenOrBuilder {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ...
                try {
                    try {
                        parsedMessage = token.PARSER.parsePartialFrom(input, extensionRegistry);
                        return this;
                    } catch (InvalidProtocolBufferException e) {
                        throw e.unwrapIOException();
                    }
    ...
    public static final class request extends GeneratedMessageV3 implements requestOrBuilder {
        ...
        public boolean equals(Object obj) {
            ...
            return result10 && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements requestOrBuilder {
            ...
            public request buildPartial() {
                ...
                if (this.tokenBuilder_ == null) {
                    ...
                    result.token_ = (token) this.tokenBuilder_.build();
                }
                if ((from_bitField0_ & 4) == 4) {
                    to_bitField0_ |= 4;
                }
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ...
                try {
                    try {
                        parsedMessage = request.PARSER.parsePartialFrom(input, extensionRegistry);
                        return this;
                    } catch (InvalidProtocolBufferException e) {
                        throw e.unwrapIOException();
                    }
            ...
            public token getToken() {
                ...
                return (token) this.tokenBuilder_.getMessage();
            }
    ...
    public static final class response extends GeneratedMessageV3 implements responseOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements responseOrBuilder {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ...
                try {
                    try {
                        parsedMessage = response.PARSER.parsePartialFrom(input, extensionRegistry);
                        return this;
                    } catch (InvalidProtocolBufferException e) {
                        throw e.unwrapIOException();
                    }
    ...
    static {
        ...
        internal_static_unsigned_descriptor = getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_request_descriptor = getDescriptor().getMessageTypes().get(2);
        internal_static_request_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_request_descriptor, new String[]{"Version", "Token", "Uuid", "Question", "System", "Apikey", "Provider", "Model", "Inputimage", "Doimage"});
        internal_static_response_descriptor = getDescriptor().getMessageTypes().get(3);
        internal_static_response_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_response_descriptor, new String[]{"Version", "Status", "Uuid", "Answer", "Outputimage"});
    }
}
