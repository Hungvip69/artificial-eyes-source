...
public abstract class Sprite extends VisibleComponent implements AlarmHandler, OnDestroyListener, Deleteable {
    ...
    private final boolean overEastEdge(int canvasWidth) {
        ...
        double dWidth = Width();
        Double.isNaN(dWidth);
        return d + dWidth > ((double) canvasWidth);
    }
    ...
    private final boolean overSouthEdge(int canvasHeight) {
        ...
        double dHeight = Height();
        Double.isNaN(dHeight);
        return d + dHeight > ((double) canvasHeight);
    }
    ...
    public BoundingBox getBoundingBox(int border) {
        ...
        double dHeight = Height();
        Double.isNaN(dHeight);
        double d12 = (d11 + dHeight) - DEFAULT_Z;
        double d13 = border;
        Double.isNaN(d13);
    ...
    private static boolean collidingBalls(Ball ball1, Ball ball2) {
        ...
        double dWidth = ball1.Width();
        Double.isNaN(dWidth);
        double xCenter1 = d + (dWidth / 2.0d);
        double d2 = ball1.yTop;
        double dHeight = ball1.Height();
        Double.isNaN(dHeight);
        double yCenter1 = d2 + (dHeight / 2.0d);
        double d3 = ball2.xLeft;
        double dWidth2 = ball2.Width();
        Double.isNaN(dWidth2);
        double xCenter2 = d3 + (dWidth2 / 2.0d);
        double d4 = ball2.yTop;
        double dHeight2 = ball2.Height();
        Double.isNaN(dHeight2);
        double yCenter2 = d4 + (dHeight2 / 2.0d);
