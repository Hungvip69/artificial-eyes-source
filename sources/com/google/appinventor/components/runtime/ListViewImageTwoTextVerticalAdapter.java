...
public class ListViewImageTwoTextVerticalAdapter extends ListAdapterWithRecyclerView {
    ...
    public ListViewImageTwoTextVerticalAdapter(ComponentContainer container, List<Object> data, int textMainColor, float textMainSize, String textMainFont, int textDetailColor, float textDetailSize, String textDetailFont, int backgroundColor, int selectionColor, int radius, int imageWidth, int imageHeight) {
