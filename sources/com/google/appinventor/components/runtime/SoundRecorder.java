    ...
    private class RecordingController {
        ...
        RecordingController(String savedRecording) throws IOException {
            ...
            if (savedRecording.equals("")) {
                absolutePath = FileUtil.getRecordingFile(SoundRecorder.this.form, "3gp").getAbsolutePath();
            } else {
                absolutePath = savedRecording;
            }
    ...
    public void Start() {
        ...
        if (!this.havePermission) {
            ...
            this.form.runOnUiThread(new Runnable() { // from class: com.google.appinventor.components.runtime.SoundRecorder.1
                ...
                public void run() {
                    SoundRecorder.this.form.askPermission(new BulkPermissionRequest(this, "Start", neededPermissions) { // from class: com.google.appinventor.components.runtime.SoundRecorder.1.1
