...
public final class Duration extends GeneratedMessageV3 implements DurationOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        int size2 = this.seconds_ != 0 ? 0 + CodedOutputStream.computeInt64Size(1, this.seconds_) : 0;
        if (this.nanos_ != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        boolean result = 1 != 0 && getSeconds() == other.getSeconds();
        return result && getNanos() == other.getNanos();
    }
