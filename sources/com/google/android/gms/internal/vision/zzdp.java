...
final class zzdp<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public final V put(@NullableDecl K k, @NullableDecl V v) {
        ...
        if (zza()) {
            ...
            Double.isNaN(d);
            int iMax2 = Math.max(4, (iMax <= ((int) (d * 1.0d)) || (iHighestOneBit = iHighestOneBit << 1) > 0) ? iHighestOneBit : 1073741824);
        ...
        if (i3 > length && (iMin = Math.min(1073741823, 1 | (Math.max(1, length >>> 1) + length))) != length) {
        ...
        if (i < size) {
            ...
            while (true) {
                ...
                if (i6 != i3) {
                    ...
                    this.zza[i4] = zzea.zza(i5, i + 1, i2);
                    return;
                }
            }
        } else {
