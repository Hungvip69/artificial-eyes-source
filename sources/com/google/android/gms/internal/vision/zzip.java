...
final class zzip extends zziq<zzjb.zzf> {
    ...
    final <UT, UB> UB zza(zzld zzldVar, Object obj, zzio zzioVar, zziu<zzjb.zzf> zziuVar, UB ub, zzlu<UT, UB> zzluVar) throws IOException {
        ...
        switch (zzis.zza[zzeVar.zzd.zzc.ordinal()]) {
            case 1:
                objZza = Double.valueOf(zzldVar.zzd());
                break;
            case 2:
                objZza = Float.valueOf(zzldVar.zze());
                break;
            case 3:
                objZza = Long.valueOf(zzldVar.zzg());
                break;
            case 4:
                objZza = Long.valueOf(zzldVar.zzf());
                break;
            case 5:
                objZza = Integer.valueOf(zzldVar.zzh());
                break;
            case 6:
                objZza = Long.valueOf(zzldVar.zzi());
                break;
            case 7:
                objZza = Integer.valueOf(zzldVar.zzj());
                break;
            case 8:
                objZza = Boolean.valueOf(zzldVar.zzk());
                break;
            case 9:
                objZza = Integer.valueOf(zzldVar.zzo());
                break;
            case 10:
                objZza = Integer.valueOf(zzldVar.zzq());
                break;
            case 11:
                objZza = Long.valueOf(zzldVar.zzr());
                break;
            case 12:
                objZza = Integer.valueOf(zzldVar.zzs());
                break;
            case 13:
                objZza = Long.valueOf(zzldVar.zzt());
                break;
            case 14:
            ...
            case 16:
                ...
                break;
            case 17:
                objZza = zzldVar.zzb(zzeVar.zzc.getClass(), zzioVar);
                break;
            case 18:
                objZza = zzldVar.zza(zzeVar.zzc.getClass(), zzioVar);
                break;
        }
        if (zzeVar.zzd.zzd) {
            zziuVar.zzb(zzeVar.zzd, objZza);
        } else {
            switch (zzis.zza[zzeVar.zzd.zzc.ordinal()]) {
                case 17:
                case 18:
                    Object objZza2 = zziuVar.zza(zzeVar.zzd);
                    if (objZza2 != null) {
                        objZza = zzjf.zza(objZza2, objZza);
                    }
                    break;
            }
            zziuVar.zza(zzeVar.zzd, objZza);
        }
        return ub;
    }
