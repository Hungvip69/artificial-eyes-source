...
public abstract class AbstractGoogleJsonClient extends AbstractGoogleClient {
    ...
    public static abstract class Builder extends AbstractGoogleClient.Builder {
        ...
        protected Builder(HttpTransport transport, JsonFactory jsonFactory, String rootUrl, String servicePath, HttpRequestInitializer httpRequestInitializer, boolean legacyDataWrapper) {
            super(transport, rootUrl, servicePath, new JsonObjectParser.Builder(jsonFactory).setWrapperKeys(legacyDataWrapper ? Arrays.asList("data", "error") : Collections.emptySet()).build(), httpRequestInitializer);
        }
