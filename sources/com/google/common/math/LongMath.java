...
public final class LongMath {
    ...
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, ErrorMessages.ERROR_NXT_INVALID_GENERATE_COLOR, 287, 214, 169, 139, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    */
    public static long divide(long r19, long r21, java.math.RoundingMode r23) {
        /*
            r0 = r23
        ...
        L2c:
            ...
            long r13 = java.lang.Math.abs(r21)
            long r13 = r13 - r11
            long r13 = r11 - r13
    ...
    public static long saturatedSubtract(long a, long b) {
        ...
        return ((naiveDifference >>> 63) ^ 1) + LocationRequestCompat.PASSIVE_INTERVAL;
    }
    ...
    public static long saturatedMultiply(long a, long b) {
        ...
        long limit = ((a ^ b) >>> 63) + LocationRequestCompat.PASSIVE_INTERVAL;
    ...
    public static long saturatedPow(long b, int k) {
        ...
        if ((b >= -2) & (b <= 2)) {
            switch ((int) b) {
                case -2:
                    if (k >= 64) {
                        return ((long) (k & 1)) + LocationRequestCompat.PASSIVE_INTERVAL;
                    }
                    return (k & 1) == 0 ? 1 << k : (-1) << k;
                case -1:
                    return (k & 1) == 0 ? 1L : -1L;
                ...
                case 1:
                    return 1L;
                case 2:
                    return k >= 63 ? LocationRequestCompat.PASSIVE_INTERVAL : 1 << k;
                default:
                    throw new AssertionError();
            }
        }
        long accum = 1;
        long limit = ((b >>> 63) & ((long) (k & 1))) + LocationRequestCompat.PASSIVE_INTERVAL;
        while (true) {
            switch (k) {
                case 0:
                    return accum;
    ...
    public static long factorial(int n) {
        ...
        return n < factorials.length ? factorials[n] : LocationRequestCompat.PASSIVE_INTERVAL;
    }
