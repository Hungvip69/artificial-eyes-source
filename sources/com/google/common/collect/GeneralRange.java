...
final class GeneralRange<T> implements Serializable {
    ...
    static <T> GeneralRange<T> downTo(Comparator<? super T> comparator, @NullableDecl T endpoint, BoundType boundType) {
    ...
    private GeneralRange(Comparator<? super T> comparator, boolean hasLowerBound, @NullableDecl T t, BoundType lowerBoundType, boolean hasUpperBound, @NullableDecl T t2, BoundType upperBoundType) {
