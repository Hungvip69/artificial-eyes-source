...
public final class CacheStats {
    ...
    public CacheStats plus(CacheStats other) {
        return new CacheStats(other.hitCount + this.hitCount, other.missCount + this.missCount, other.loadSuccessCount + this.loadSuccessCount, other.loadExceptionCount + this.loadExceptionCount, other.totalLoadTime + this.totalLoadTime, this.evictionCount + other.evictionCount);
    }
