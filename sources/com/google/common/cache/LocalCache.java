    ...
    ImmutableMap<K, V> getAll(Iterable<? extends K> keys) throws ExecutionException {
        ...
        for (K key : keys) {
            ...
            if (!linkedHashMapNewLinkedHashMap.containsKey(key)) {
                linkedHashMapNewLinkedHashMap.put(key, obj);
                if (obj == null) {
                    misses++;
            ...
            if (!linkedHashSetNewLinkedHashSet.isEmpty()) {
                try {
                    ...
                    for (Object obj2 : linkedHashSetNewLinkedHashSet) {
                        ...
                        linkedHashMapNewLinkedHashMap.put(obj2, value);
                    }
                } catch (CacheLoader.UnsupportedLoadingOperationException e) {
                    for (Object obj3 : linkedHashSetNewLinkedHashSet) {
                        misses--;
                        linkedHashMapNewLinkedHashMap.put(obj3, get(obj3, this.defaultLoader));
                    }
                }
            }
            return ImmutableMap.copyOf((Map) linkedHashMapNewLinkedHashMap);
