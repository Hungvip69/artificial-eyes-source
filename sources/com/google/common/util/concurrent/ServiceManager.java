...
public final class ServiceManager {
    ...
    public String toString() {
        return MoreObjects.toStringHelper((Class<?>) ServiceManager.class).add(ComponentDescriptorConstants.SERVICES_TARGET, Collections2.filter(this.services, Predicates.not(Predicates.instanceOf(NoOpService.class)))).toString();
    }
