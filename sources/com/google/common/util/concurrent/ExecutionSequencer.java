...
public final class ExecutionSequencer {
    ...
    public <T> ListenableFuture<T> submitAsync(final AsyncCallable<T> callable, final Executor executor) {
        ...
        AsyncCallable<T> task = new AsyncCallable<T>() { // from class: com.google.common.util.concurrent.ExecutionSequencer.2
            @Override // com.google.common.util.concurrent.AsyncCallable
            public ListenableFuture<T> call() throws Exception {
                if (!ExecutionSequencer$2$$ExternalSyntheticBackportWithForwarding0.m(runningState, RunningState.NOT_RUN, RunningState.STARTED)) {
        ...
        Runnable listener = new Runnable() { // from class: com.google.common.util.concurrent.ExecutionSequencer.4
            ...
            public void run() {
                if (taskFuture.isDone() || (outputFuture.isCancelled() && ExecutionSequencer$2$$ExternalSyntheticBackportWithForwarding0.m(runningState, RunningState.NOT_RUN, RunningState.CANCELLED))) {
