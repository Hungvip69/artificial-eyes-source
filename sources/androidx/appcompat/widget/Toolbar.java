...
public class Toolbar extends ViewGroup {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (zShouldLayout || zShouldLayout2) {
            ...
            switch (this.mGravity & 112) {
                ...
                default:
                    ...
                    if (iMax2 < layoutParams3.topMargin + this.mTitleMarginTop) {
                        ...
                        int i15 = (((height - paddingBottom) - measuredHeight) - iMax2) - paddingTop2;
                        if (i15 < layoutParams3.bottomMargin + this.mTitleMarginBottom) {
                            iMax2 = Math.max(0, iMax2 - ((layoutParams4.bottomMargin + this.mTitleMarginBottom) - i15));
                        }
                    }
            ...
            if (z2) {
                ...
                if (!zShouldLayout2) {
                    ...
                    int i17 = paddingTop + layoutParams6.topMargin;
                    this.mSubtitleTextView.layout(iMin2 - this.mSubtitleTextView.getMeasuredWidth(), i17, iMin2, this.mSubtitleTextView.getMeasuredHeight() + i17);
                    i13 = iMin2 - this.mTitleMarginEnd;
                    int i18 = layoutParams6.bottomMargin;
                }
                if (z3) {
                ...
                if (!zShouldLayout2) {
                    ...
                    int i20 = paddingTop + layoutParams8.topMargin;
                    int measuredWidth3 = this.mSubtitleTextView.getMeasuredWidth() + iMax;
                    this.mSubtitleTextView.layout(iMax, i20, measuredWidth3, this.mSubtitleTextView.getMeasuredHeight() + i20);
                    i11 = measuredWidth3 + this.mTitleMarginEnd;
                    int i21 = layoutParams8.bottomMargin;
                }
                if (z3) {
        ...
        for (int i22 = 0; i22 < size; i22++) {
            iMax = layoutChildLeft(this.mTempViews.get(i22), iMax, iArr, i8);
        }
        int i23 = i8;
        addCustomViewsWithGravity(this.mTempViews, 5);
        int size2 = this.mTempViews.size();
        for (int i24 = 0; i24 < size2; i24++) {
            iMin2 = layoutChildRight(this.mTempViews.get(i24), iMin2, iArr, i23);
        }
        addCustomViewsWithGravity(this.mTempViews, 1);
        int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
        int i25 = (i7 + (((i6 - i7) - i5) / 2)) - (viewListMeasuredWidth / 2);
        int i26 = viewListMeasuredWidth + i25;
        if (i25 >= iMax) {
            if (i26 <= iMin2) {
                iMax = i25;
            } else {
        ...
        while (i9 < size3) {
            iMax = layoutChildLeft(this.mTempViews.get(i9), iMax, iArr, i23);
            i9++;
        }
