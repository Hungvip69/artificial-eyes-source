...
public class ConstraintWidget {
    ...
    /* JADX WARN: Removed duplicated region for block: B:131:0x0289 A[RETURN] */
    ...
    */
    ...
    private void applyConstraints(LinearSystem system, boolean parentWrapContent, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean inChain, int matchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        if (!variableSize3) {
            if (wrapContent) {
                ...
                if (maxDimension < Integer.MAX_VALUE) {
                    system.addLowerThan(end2, begin3, maxDimension, i6);
                }
            } else {
            ...
            if (matchMaxDimension4 > 0) {
                system.addLowerThan(end2, begin3, matchMaxDimension4, i);
        ...
        if (!applyPosition || inChain) {
            ...
            int matchConstraintDefault4 = numConnections2;
            SolverVariable begin5 = end2;
            if (matchConstraintDefault4 < i8 && parentWrapContent) {
                system.addGreaterThan(begin4, parentMin, i7, 6);
                system.addGreaterThan(parentMax, begin5, i7, 6);
                return;
            }
            return;
        }
            ...
            if (isBeginConnected && isEndConnected) {
                ...
                if (!variableSize) {
                    ...
                    if (parentWrapContent && minDimension == 0) {
                        system.addGreaterThan(end2, begin3, 0, i3);
                    }
                ...
                if (applyCentering) {
                    ...
                    begin2 = begin3;
                    system.addCentering(begin3, beginTarget2, beginAnchor.getMargin(), bias, endTarget2, end2, endAnchor.getMargin(), centeringStrength);
                    i4 = 0;
                ...
                if ((variableSize || !applyEndConstraint) && !applyBoundsCheck) {
                    ...
                    begin = end;
                    system.addLowerThan(begin, endTarget2, -endAnchor.getMargin(), endStrength);
                }
                if (!parentWrapContent) {
                    i5 = 6;
                } else {
        ...
        if (parentWrapContent) {
            system.addGreaterThan(parentMax, begin, i4, i5);
        }
    }
