...
public class Declaration implements SourceLocator {
    ...
    */
    public void load(gnu.expr.AccessExp r19, int r20, gnu.expr.Compilation r21, gnu.expr.Target r22) {
        /*
    ...
    public static Declaration getDeclarationValueFromStatic(String className, String fieldName, String name) {
        try {
            java.lang.reflect.Field fld = Class.forName(className).getDeclaredField(fieldName);
