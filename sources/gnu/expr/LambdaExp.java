...
public class LambdaExp extends ScopeExp {
    ...
    Field allocFieldFor(Compilation comp) {
        ...
        if (this.nameDecl != null && (this.nameDecl.context instanceof ModuleExp)) {
            ...
            StringBuilder sbAppend = new StringBuilder().append(fname).append("$Fn");
            int i = comp.localFieldIndex + 1;
            comp.localFieldIndex = i;
            fname = sbAppend.append(i).toString();
            if (!needsClosure) {
                fflags = 16 | 8;
            }
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:168:0x0239 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:170:0x023d  */
    /* JADX WARN: Removed duplicated region for block: B:173:0x0246 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:89:0x0110 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Type inference failed for: r17v8, types: [short] */
    /* JADX WARN: Type inference failed for: r17v9 */
    /* JADX WARN: Type inference failed for: r8v33, types: [gnu.expr.Declaration] */
    ...
    */
    ...
    public void print(OutPort out) {
        ...
        int opt_args = this.defaultArgs != null ? this.defaultArgs.length - key_args : 0;
        Declaration decl = firstDecl();
