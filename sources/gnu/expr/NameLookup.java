...
public class NameLookup extends GeneralHashTable<Object, Declaration> {
    ...
    public void push(Declaration decl) {
        ...
        HashNode<Object, Declaration> hashNodeMakeEntry = makeEntry(symbol, hash, decl);
        int index = hashToIndex(hash);
        hashNodeMakeEntry.next = ((HashNode[]) this.table)[index];
        ((HashNode[]) this.table)[index] = hashNodeMakeEntry;
    }
