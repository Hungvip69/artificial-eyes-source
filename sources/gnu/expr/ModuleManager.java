...
public class ModuleManager {
    ...
    public synchronized void register(String moduleClass, String moduleSource, String moduleUri) {
        ...
        if (sourcePath.isAbsolute()) {
            ...
            try {
                ...
                String setClassName = cls.getName().replace('.', '/') + ".class";
                URL setClassURL = cls.getClassLoader().getResource(setClassName);
    ...
    public synchronized void loadPackageInfo(String packageName) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
