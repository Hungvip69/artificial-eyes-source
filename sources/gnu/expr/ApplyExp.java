...
public class ApplyExp extends Expression {
    ...
    static void compile(ApplyExp exp, Compilation comp, Target target, boolean checkInlineable) {
        ...
        Declaration owner;
        String func_name;
        LambdaExp func_lambda;
        Method method;
        Method method2;
        int args_length = exp.args.length;
        Expression exp_func = exp.func;
        LambdaExp func_lambda2 = null;
        String func_name2 = null;
        Object quotedValue2 = null;
        if (exp_func instanceof LambdaExp) {
            LambdaExp func_lambda3 = (LambdaExp) exp_func;
            String func_name3 = func_lambda3.getName();
            if (func_name3 == null) {
                quotedValue = null;
                owner = null;
                func_name = "<lambda>";
                func_lambda = func_lambda3;
            } else {
                quotedValue = null;
                owner = null;
                func_name = func_name3;
                func_lambda = func_lambda3;
            }
        } else if (exp_func instanceof ReferenceExp) {
            ReferenceExp func_ref = (ReferenceExp) exp_func;
            Declaration owner2 = func_ref.contextDecl();
            ...
            while (func_decl != null && func_decl.isAlias() && (func_decl.value instanceof ReferenceExp)) {
                ...
                if (owner2 != null || func_decl.needsContext() || func_ref2.binding == null) {
                    break;
                }
                func_decl = func_ref2.binding;
                owner2 = func_ref2.contextDecl();
            }
            if (!func_decl.getFlag(65536L)) {
                Expression value = func_decl.getValue();
                func_name2 = func_decl.getName();
                if (value != null && (value instanceof LambdaExp)) {
                    func_lambda2 = (LambdaExp) value;
                }
                if (value != null && (value instanceof QuoteExp)) {
                    quotedValue2 = ((QuoteExp) value).getValue();
                }
            }
            quotedValue = quotedValue2;
            owner = owner2;
            func_name = func_name2;
            func_lambda = func_lambda2;
        ...
        if (func_lambda != null && func_lambda.getInlineOnly() && !tail_recurse && func_lambda.min_args == args_length) {
            ...
            if (!func_lambda.getFlag(128)) {
                func_lambda.flags = 128 | func_lambda.flags;
        ...
        if (!comp.curLambda.isHandlingTailCalls() || ((!exp.isTailCall() && !(target instanceof ConsumerTarget)) || comp.curLambda.getInlineOnly())) {
            ...
            if (!tail_recurse ? args_length <= 4 : func_lambda.min_args == func_lambda.max_args) {
                z = false;
            }
            boolean toArray = z;
            int[] incValues = null;
    ...
    */
    private static void pushArgs(gnu.expr.LambdaExp r6, gnu.expr.Expression[] r7, int[] r8, gnu.expr.Compilation r9) {
        /*
            gnu.expr.Declaration r0 = r6.firstDecl()
            int r1 = r7.length
            r2 = 0
        L6:
            if (r2 >= r1) goto L35
            r3 = r7[r2]
            boolean r4 = r0.ignorable()
            if (r4 == 0) goto L16
            gnu.expr.Target r4 = gnu.expr.Target.Ignore
            r3.compile(r9, r4)
            goto L2e
        L16:
            if (r8 == 0) goto L23
            int r4 = gnu.expr.SetExp.canUseInc(r3, r0)
            r8[r2] = r4
        ...
        L23:
            ...
            gnu.expr.Target r4 = gnu.expr.StackTarget.getInstance(r4)
            r3.compileWithPosition(r9, r4)
        L2e:
        ...
        L35:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gnu.expr.ApplyExp.pushArgs(gnu.expr.LambdaExp, gnu.expr.Expression[], int[], gnu.expr.Compilation):void");
    }
