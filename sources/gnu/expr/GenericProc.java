...
public class GenericProc extends MethodProc {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:7:0x0013, code lost:
        ...
        java.lang.System.arraycopy(r7.methods, r1, r7.methods, r1 + 1, r0 - r1);
        r7.methods[r1] = r8;
     */
    /*
    ...
    */
    public synchronized void add(gnu.mapping.MethodProc r8) {
        /*
            r7 = this;
            monitor-enter(r7)
            int r0 = r7.count     // Catch: java.lang.Throwable -> L28
            r7.addAtEnd(r8)     // Catch: java.lang.Throwable -> L28
            r1 = 0
        L7:
            if (r1 >= r0) goto L26
            gnu.mapping.MethodProc[] r2 = r7.methods     // Catch: java.lang.Throwable -> L28
            r2 = r2[r1]     // Catch: java.lang.Throwable -> L28
            gnu.mapping.MethodProc r2 = gnu.mapping.MethodProc.mostSpecific(r8, r2)     // Catch: java.lang.Throwable -> L28
            if (r2 != r8) goto L23
            gnu.mapping.MethodProc[] r3 = r7.methods     // Catch: java.lang.Throwable -> L28
            gnu.mapping.MethodProc[] r4 = r7.methods     // Catch: java.lang.Throwable -> L28
            int r5 = r1 + 1
            int r6 = r0 - r1
            java.lang.System.arraycopy(r3, r1, r4, r5, r6)     // Catch: java.lang.Throwable -> L28
            gnu.mapping.MethodProc[] r3 = r7.methods     // Catch: java.lang.Throwable -> L28
            r3[r1] = r8     // Catch: java.lang.Throwable -> L28
            goto L26
        L23:
            int r1 = r1 + 1
            goto L7
    ...
    public int matchN(Object[] args, CallContext ctx) {
        ...
        for (int j = 0; j < alen; j++) {
            ...
            if (arg == null) {
                ...
                if (language != null) {
                    atype = language.getTypeFor(cls);
                } else {
                    Type atype2 = Type.make(cls);
                    atype = atype2;
                }
            }
            atypes[j] = atype;
