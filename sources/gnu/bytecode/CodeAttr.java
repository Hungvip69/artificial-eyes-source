...
public class CodeAttr extends Attribute implements AttrContainer {
    ...
    /* JADX WARN: Removed duplicated region for block: B:35:0x00b0 A[PHI: r5 r7 r8
      0x00b0: PHI (r5v1 'ival' long) = 
      (r5v0 'ival' long)
      (r5v2 'ival' long)
      (r5v3 'ival' long)
      (r5v0 'ival' long)
      ...
      (r5v6 'ival' long)
      (r5v7 'ival' long)
     binds: [B:5:0x0024, B:33:0x00ab, B:30:0x009b, B:27:0x008b, B:24:0x007c, B:21:0x006c, B:18:0x005b, B:15:0x004b, B:12:0x003a] A[DONT_GENERATE, DONT_INLINE]
      0x00b0: PHI (r7v1 'fval' float) = 
      (r7v0 'fval' float)
      (r7v0 'fval' float)
      (r7v0 'fval' float)
      (r7v0 'fval' float)
    ...
    */
        ...
        do {
            ...
            if (arg_count >= 0) {
                ...
                if (is_init) {
                    ...
                    int i3 = this.local_types != null ? this.local_types.length : 0;
                    while (true) {
                        i3--;
                        if (i3 < 0) {
                            break;
    ...
    /* JADX WARN: Removed duplicated region for block: B:190:0x013d A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:191:0x012f A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    public void disAssemble(ClassTypeWriter classTypeWriter, int start, int limit) {
        int index;
        int i;
        int i2;
        short s;
        ...
        while (oldpc < limit) {
            ...
            if (op3 < 120) {
                if (op3 < 87) {
                    if (op3 < 3) {
                        print("nop;aconst_null;iconst_m1;", op3, classTypeWriter);
                    } else if (op3 < 9) {
                        classTypeWriter.print("iconst_");
                        classTypeWriter.print(op3 - 3);
                    } else if (op3 < 16) {
                        if (op3 < 11) {
                            typ = 'l';
                            op2 = op3 - 9;
                        ...
                        classTypeWriter.print(typ);
                        classTypeWriter.print("const_");
                        classTypeWriter.print(op2);
                    } else if (op3 < 21) {
                        if (op3 < 18) {
                            print("bipush ;sipush ;", op3 - 16, classTypeWriter);
                            if (op3 == 16) {
                                i5 = constant + 1;
                                unsignedShort = this.code[constant];
                            } else {
                                i5 = constant + 2;
                                unsignedShort = (short) readUnsignedShort(constant);
                            }
                            classTypeWriter.print((int) unsignedShort);
                            constant = i5;
                        } else {
                            printConstant = op3 == 18 ? 1 : 2;
                            print("ldc;ldc_w;ldc2_w;", op3 - 18, classTypeWriter);
                        }
                    } else {
                        if (op3 < 54) {
                            load_or_store = "load";
                        ...
                        classTypeWriter.print("ilfdabcs".charAt(op));
                        if (index2 == -2) {
                            classTypeWriter.write(97);
                        }
                        classTypeWriter.print(load_or_store);
                        if (index2 >= 0) {
                            classTypeWriter.write(95);
                            classTypeWriter.print(index2);
                        } else if (index2 == -1) {
                            if (wide) {
                                index3 = readUnsignedShort(constant);
                                constant += 2;
                            } else {
                                index3 = this.code[constant] & 255;
                                constant++;
                            }
                            wide = false;
                            classTypeWriter.print(' ');
                            classTypeWriter.print(index3);
                        }
                    }
                } else if (op3 < 96) {
                    print("pop;pop2;dup;dup_x1;dup_x2;dup2;dup2_x1;dup2_x2;swap;", op3 - 87, classTypeWriter);
                } else {
                    classTypeWriter.print("ilfda".charAt((op3 - 96) % 4));
                    print("add;sub;mul;div;rem;neg;", (op3 - 96) >> 2, classTypeWriter);
                }
            } else if (op3 < 170) {
                if (op3 < 132) {
                    classTypeWriter.print((op3 & 1) == 0 ? 'i' : 'l');
                    print("shl;shr;ushr;and;or;xor;", (op3 - 120) >> 1, classTypeWriter);
                } else if (op3 == 132) {
                    classTypeWriter.print("iinc");
                    if (!wide) {
                        int i6 = constant + 1;
                        i2 = this.code[constant] & 255;
                        i = i6 + 1;
                        s = this.code[i6];
                    } else {
                        int var_index = readUnsignedShort(constant);
                        int i7 = constant + 2;
                        short constant2 = (short) readUnsignedShort(i7);
                        wide = false;
                        i = i7 + 2;
                        i2 = var_index;
                        s = constant2;
                    ...
                    classTypeWriter.print(' ');
                    classTypeWriter.print((int) s);
                    constant = i;
                } else if (op3 < 148) {
                    classTypeWriter.print("ilfdi".charAt((op3 - 133) / 3));
                    classTypeWriter.print('2');
                    classTypeWriter.print("lfdifdildilfbcs".charAt(op3 - 133));
                } else if (op3 < 153) {
                    print("lcmp;fcmpl;fcmpg;dcmpl;dcmpg;", op3 - 148, classTypeWriter);
                } else if (op3 < 169) {
                    if (op3 < 159) {
                        classTypeWriter.print("if");
                        print("eq;ne;lt;ge;gt;le;", op3 - 153, classTypeWriter);
                    } else if (op3 >= 167) {
                        print("goto;jsr;", op3 - 167, classTypeWriter);
                    } else {
                        if (op3 < 165) {
                        ...
                        print("eq;ne;lt;ge;gt;le;", op3 - 159, classTypeWriter);
                    }
                    short delta = (short) readUnsignedShort(constant);
                    constant += 2;
                    classTypeWriter.print(' ');
                    classTypeWriter.print(oldpc + delta);
                } else {
                    ...
                    if (wide) {
                        ...
                        index = this.code[constant] & 255;
                        constant++;
                    }
                    wide = false;
                    classTypeWriter.print(index);
                }
            } else if (op3 < 172) {
                ...
                if (op3 == 170) {
                    ...
                    classTypeWriter.print(oldpc + code_offset);
                    while (low <= high) {
                        ...
                        classTypeWriter.print(low);
                        classTypeWriter.print(": ");
                        classTypeWriter.print(oldpc + code_offset2);
                        low++;
                    }
                } else {
                    classTypeWriter.print("lookupswitch");
                    int npairs = readInt(i8);
                    constant = i8 + 4;
                    ...
                    while (true) {
                        ...
                        int i10 = constant + 4;
                        int code_offset3 = readInt(i10);
                        constant = i10 + 4;
                        classTypeWriter.println();
                        classTypeWriter.print("  ");
                        classTypeWriter.print(match);
                        classTypeWriter.print(": ");
                        classTypeWriter.print(oldpc + code_offset3);
                    }
                }
            } else if (op3 < 178) {
                if (op3 < 177) {
                    classTypeWriter.print("ilfda".charAt(op3 - 172));
                }
                classTypeWriter.print("return");
            } else if (op3 < 182) {
                print("getstatic;putstatic;getfield;putfield;", op3 - 178, classTypeWriter);
                printConstant = 2;
            } else if (op3 < 185) {
                classTypeWriter.print("invoke");
                print("virtual;special;static;", op3 - 182, classTypeWriter);
                printConstant = 2;
            } else if (op3 == 185) {
                classTypeWriter.print("invokeinterface (");
                int index5 = readUnsignedShort(constant);
                int i11 = constant + 2;
                int args = this.code[i11] & 255;
                constant = i11 + 2;
                classTypeWriter.print(args + " args)");
                classTypeWriter.printConstantOperand(index5);
            } else if (op3 < 196) {
                print("186;new;newarray;anewarray;arraylength;athrow;checkcast;instanceof;monitorenter;monitorexit;", op3 - 186, classTypeWriter);
                if (op3 == 187 || op3 == 189 || op3 == 192 || op3 == 193) {
                    printConstant = 2;
                } else if (op3 == 188) {
                    int i12 = constant + 1;
                    byte type = this.code[constant];
                    classTypeWriter.print(' ');
                    if (type >= 4 && type <= 11) {
                        print("boolean;char;float;double;byte;short;int;long;", type - 4, classTypeWriter);
                    } else {
                        classTypeWriter.print((int) type);
                    }
                    constant = i12;
                }
            } else if (op3 == 196) {
                ...
                int i13 = constant + 2;
                classTypeWriter.printConstantOperand(index6);
                int i14 = i13 + 1;
                int dims = this.code[i13] & 255;
                classTypeWriter.print(' ');
                classTypeWriter.print(dims);
                constant = i14;
            } else if (op3 < 200) {
                print("ifnull;ifnonnull;", op3 - 198, classTypeWriter);
                short delta2 = (short) readUnsignedShort(constant);
                constant += 2;
                classTypeWriter.print(' ');
                classTypeWriter.print(oldpc + delta2);
            } else if (op3 < 202) {
                print("goto_w;jsr_w;", op3 - 200, classTypeWriter);
                int delta3 = readInt(constant);
                constant += 4;
                classTypeWriter.print(' ');
                classTypeWriter.print(oldpc + delta3);
            } else {
                classTypeWriter.print(op3);
            }
            if (printConstant > 0) {
                if (printConstant == 1) {
                    i3 = constant + 1;
                ...
                classTypeWriter.printConstantOperand(i4);
                constant = i3;
            }
            classTypeWriter.println();
            oldpc = constant;
