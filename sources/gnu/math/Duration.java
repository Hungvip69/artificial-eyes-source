...
public class Duration extends Quantity implements Externalizable {
    ...
    public static Duration valueOf(String str, Unit unit) {
        ...
        if (ch2 == 'M') {
            months = (int) (((long) months) + (part2 >> 32));
            pos2 = ((int) part2) >> 16;
            part2 = scanPart(str2, pos2);
            ch2 = (char) part2;
        }
        ...
        if (ch2 == 'D') {
            ...
            seconds = ((long) ((int) (part2 >> 32))) * 86400;
            pos2 = ((int) part2) >> 16;
            part2 = scanPart(str2, pos2);
        }
        if (part2 != (pos2 << 16)) {
        ...
        if (pos2 == len) {
            ...
            char ch3 = (char) part3;
            if (ch3 == 'H') {
                seconds += (long) (((int) (part3 >> 32)) * 3600);
                pos2 = ((int) part3) >> 16;
    ...
    public static Duration times(Duration x, double y) {
        ...
        double d2 = (x.seconds * 1000000000) + ((long) x.nanos);
        Double.isNaN(d2);
        double nanos = d2 * y;
    ...
    private static long scanPart(String str, int start) {
        ...
        while (i < len) {
            ...
            int dig = Character.digit(ch, 10);
            if (dig < 0) {
                return val < 0 ? start << 16 : (val << 32) | ((long) (i << 16)) | ((long) ch);
            }
            val = val < 0 ? dig : (10 * val) + ((long) dig);
            if (val > 2147483647L) {
                return -1L;
            }
        }
