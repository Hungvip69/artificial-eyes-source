...
public class ReaderXmlElement extends ReadTableEntry {
    ...
    public static Object readQNameExpression(LispReader reader, int ch, boolean forElement) throws SyntaxException, IOException {
        reader.getName();
    ...
    static Object readEscapedExpression(LispReader reader, int ch) throws SyntaxException, IOException {
        if (ch == 40) {
            reader.unread(ch);
    ...
    static Object readXMLConstructor(LispReader reader, int next, boolean inElementContent) throws SyntaxException, IOException {
    ...
    */
    public static java.lang.Object readElementConstructor(gnu.kawa.lispexpr.LispReader r23, int r24) throws gnu.text.SyntaxException, java.io.IOException {
        /*
    ...
    public static Pair readContent(LispReader reader, char delimiter, Pair resultTail) throws SyntaxException, IOException {
        reader.tokenBufferLength = 0;
    ...
    static void readCharRef(LispReader reader) throws SyntaxException, IOException {
        int base;
        int next = reader.read();
        if (next == 120) {
            base = 16;
    ...
    static Object readEntity(LispReader reader, int next) throws SyntaxException, IOException {
    ...
    static int skipSpace(LispReader reader, int ch) throws SyntaxException, IOException {
