...
/* JADX INFO: compiled from: LispFormat.java */
...
class LispEscapeFormat extends ReportFormat {
    ...
    public int format(Object[] args, int start, Writer dst, FieldPosition fpos) throws IOException {
        ...
        if (this.param1 == -1073741824) {
            ...
            Numeric param = getParam(this.param1, args, start);
            ...
            if (this.param2 == -1073741824) {
                ...
                Numeric param2 = getParam(this.param2, args, start);
                ...
                if (this.param3 == -1073741824) {
                    ...
                    Numeric param3 = getParam(this.param3, args, start);
