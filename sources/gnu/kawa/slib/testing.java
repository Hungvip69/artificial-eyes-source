...
/* JADX INFO: compiled from: testing.scm */
...
public class testing extends ModuleBody {
    ...
    static {
        ...
        IntNum intNumMake = IntNum.make(1);
        Lit13 = intNumMake;
        Object[] objArr2 = {Lit128, PairWithPosition.make(intNumMake, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/testing.scm", 3727384)};
        ...
        Lit123 = new SyntaxTemplate("\u0001\u0001\u0001", "\u0011\u0018\u0004\u0011\u0018\fA\u0011\u0018\u0014\u0011\u0018\u001c\b\u0013\b\u0011\u0018$\u0011\u0018\u001c\u0011\u0018,\b\u000b", new Object[]{Lit150, pairWithPositionMake3, simpleSymbol17, Lit149, simpleSymbol18, Boolean.TRUE}, 0);
        ...
        PairWithPosition pairWithPositionMake4 = PairWithPosition.make(Lit149, PairWithPosition.make(PairWithPosition.make(Lit60, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/testing.scm", 3469326), LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/testing.scm", 3469326), "/u2/home/jis/ai2-kawa/gnu/kawa/slib/testing.scm", 3469323);
        ...
        Lit114 = new SyntaxTemplate("\u0001\u0001\u0001\u0001\u0001", "\u0011\u0018\u0004\u0011\u0018\fA\u0011\u0018\u0014\u0011\u0018\u001c\b#\b\u0011\u0018$\u0011\u0018\u001c)\u0011\u0018,\b\u001b\t\u000b\b\u0013", new Object[]{Lit150, pairWithPositionMake10, Lit52, Lit149, simpleSymbol25, simpleSymbol26}, 0);
    ...
    public static LList testRunnerGroupPath(Object runner) {
        try {
            Object objTestRunnerGroupStack = testRunnerGroupStack((test$Mnrunner) runner);
            try {
                return lists.reverse((LList) objTestRunnerGroupStack);
            } catch (ClassCastException e) {
                throw new WrongType(e, "reverse", 1, objTestRunnerGroupStack);
            }
        } catch (ClassCastException e2) {
    ...
    public static Object testRunnerGet() throws Throwable {
    ...
    static Object $PcTestAnySpecifierMatches(Object list, Object runner) throws Throwable {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x0051, code lost:
        ...
        testResultSet$Ex(r4, gnu.kawa.slib.testing.Lit1, gnu.kawa.slib.testing.Lit3);
     */
    ...
    */
    public static java.lang.Object $PcTestShouldExecute(java.lang.Object r4) throws java.lang.Throwable {
        /*
            r0 = 0
            r1 = r4
            gnu.kawa.slib.test$Mnrunner r1 = (gnu.kawa.slib.test$Mnrunner) r1     // Catch: java.lang.ClassCastException -> L7a
        ...
        L15:
            ...
            java.lang.Boolean r2 = java.lang.Boolean.FALSE     // Catch: java.lang.ClassCastException -> L70
            if (r1 == r2) goto L1f
            r2 = 1
            goto L20
        L1f:
        ...
        L28:
            r1 = r4
            gnu.kawa.slib.test$Mnrunner r1 = (gnu.kawa.slib.test$Mnrunner) r1     // Catch: java.lang.ClassCastException -> L67
        ...
        L42:
            r1 = r4
            gnu.kawa.slib.test$Mnrunner r1 = (gnu.kawa.slib.test$Mnrunner) r1     // Catch: java.lang.ClassCastException -> L5e
    ...
    public static void $PcTestBegin(Object suite$Mnname, Object count) throws Throwable {
    ...
    static Object $PcTestFormatLine(Object runner) throws Throwable {
        try {
            ...
            Object objApply1 = lists.cdr.apply1(source$Mnline);
            try {
                return strings.stringAppend(file, ":", numbers.number$To$String((Number) objApply1), ": ");
            } catch (ClassCastException e) {
                throw new WrongType(e, "number->string", 1, objApply1);
            }
        } catch (ClassCastException e2) {
    ...
    public static Object $PcTestEnd(Object suite$Mnname, Object line$Mninfo) throws Throwable {
    ...
    static Object testOnTestBeginSimple(Object runner) throws Throwable {
        try {
            Object log = testRunnerAuxValue((test$Mnrunner) runner);
            if (!ports.isOutputPort(log)) {
                return Values.empty;
    ...
    public static Object testOnTestEndSimple(Object runner) throws Throwable {
        Object pair;
        try {
            Object log = testRunnerAuxValue((test$Mnrunner) runner);
            try {
    ...
    public static Object testResultSet$Ex(Object runner, Object pname, Object value) throws Throwable {
        try {
    ...
    public static Object testResultKind$V(Object[] argsArray) throws Throwable {
    ...
    public static Object isTestPassed$V(Object[] argsArray) throws Throwable {
        LList rest = LList.makeList(argsArray, 0);
    ...
    public static Object $PcTestReportResult() throws Throwable {
        Object r = testRunnerGet();
    ...
    public static boolean $PcTestOnTestBegin(Object r) throws Throwable {
    ...
    public static Object $PcTestOnTestEnd(Object r, Object result) throws Throwable {
    ...
    public static Object testRunnerTestName(Object runner) throws Throwable {
        try {
    ...
    public class frame0 extends ModuleBody {
        ...
        boolean lambda5(Object value, Object expected) throws Throwable {
            Object objApply2 = Scheme.numGEq.apply2(value, AddOp.$Mn.apply2(expected, this.error));
            try {
    ...
    static Object lambda16(Object x) {
        Pair pairList2 = LList.list2(x, LList.list2(Lit15, $PcTestSourceLine2(x)));
        Object[] objArrAllocVars = SyntaxPattern.allocVars(3, null);
        if (Lit95.match(pairList2, objArrAllocVars, 0)) {
            return Lit96.execute(objArrAllocVars, TemplateScope.make());
        }
        if (!Lit97.match(pairList2, objArrAllocVars, 0)) {
            return syntax_case.error("syntax-case", pairList2);
        }
        return Lit98.execute(objArrAllocVars, TemplateScope.make());
    }

    static Object lambda17(Object x) {
        Pair pairList2 = LList.list2(x, LList.list2(Lit15, $PcTestSourceLine2(x)));
        Object[] objArrAllocVars = SyntaxPattern.allocVars(4, null);
        if (Lit100.match(pairList2, objArrAllocVars, 0)) {
            return Lit101.execute(objArrAllocVars, TemplateScope.make());
        }
        if (!Lit102.match(pairList2, objArrAllocVars, 0)) {
            return syntax_case.error("syntax-case", pairList2);
        }
        return Lit103.execute(objArrAllocVars, TemplateScope.make());
    }

    static Object $PcTestComp2(Object comp, Object x) {
        Pair pairList3 = LList.list3(x, LList.list2(Lit15, $PcTestSourceLine2(x)), comp);
        Object[] objArrAllocVars = SyntaxPattern.allocVars(6, null);
        if (Lit16.match(pairList3, objArrAllocVars, 0)) {
            return Lit17.execute(objArrAllocVars, TemplateScope.make());
        }
        if (!Lit18.match(pairList3, objArrAllocVars, 0)) {
            return syntax_case.error("syntax-case", pairList3);
        }
        return Lit19.execute(objArrAllocVars, TemplateScope.make());
    }
    ...
    static Object lambda21(Object x) {
        Pair pairList2 = LList.list2(x, LList.list2(Lit15, $PcTestSourceLine2(x)));
        Object[] objArrAllocVars = SyntaxPattern.allocVars(6, null);
        if (Lit111.match(pairList2, objArrAllocVars, 0)) {
            return Lit112.execute(objArrAllocVars, TemplateScope.make());
        }
        if (!Lit113.match(pairList2, objArrAllocVars, 0)) {
            return syntax_case.error("syntax-case", pairList2);
        }
        return Lit114.execute(objArrAllocVars, TemplateScope.make());
    }

    static Object lambda22(Object x) {
        Pair pairList2 = LList.list2(x, LList.list2(Lit15, $PcTestSourceLine2(x)));
        Object[] objArrAllocVars = SyntaxPattern.allocVars(5, null);
        if (Lit118.match(pairList2, objArrAllocVars, 0)) {
            return Lit119.execute(objArrAllocVars, TemplateScope.make());
        }
        if (Lit120.match(pairList2, objArrAllocVars, 0)) {
            return Lit121.execute(objArrAllocVars, TemplateScope.make());
        }
        if (!Lit122.match(pairList2, objArrAllocVars, 0)) {
            return syntax_case.error("syntax-case", pairList2);
        }
        return Lit123.execute(objArrAllocVars, TemplateScope.make());
    }
    ...
    public static Object testApply$V(Object first, Object[] argsArray) throws Throwable {
    ...
    public class frame2 extends ModuleBody {
        ...
        boolean lambda12(Object runner) throws Throwable {
            this.i = AddOp.$Pl.apply2(this.i, testing.Lit13);
            Object objApply2 = Scheme.numGEq.apply2(this.i, this.n);
            try {
                boolean x = ((Boolean) objApply2).booleanValue();
    ...
    public class frame3 extends ModuleBody {
        ...
        Object lambda13(Object runner) throws Throwable {
    ...
    public class frame4 extends ModuleBody {
        ...
        Object lambda14(Object runner) throws Throwable {
            Object result = Boolean.FALSE;
            for (Object l = this.pred$Mnlist; !lists.isNull(l); l = lists.cdr.apply1(l)) {
                if (Scheme.applyToArgs.apply2(lists.car.apply1(l), runner) != Boolean.FALSE) {
                    result = Boolean.TRUE;
    ...
    public static Object testReadEvalString(Object string) throws SyntaxException, IOException {
        try {
