...
/* JADX INFO: compiled from: enums.scm */
...
public class enums extends ModuleBody {
    ...
    static SimpleSymbol symbolAppend$V(Object[] argsArray) throws Throwable {
    ...
    static Object makeFieldDesc(Symbol t$Mnname, Symbol e$Mnname, int e$Mnval) {
        return LList.consX(new Object[]{e$Mnname, Quote.append$V(new Object[]{Lit0, LList.consX(new Object[]{t$Mnname, Quote.append$V(new Object[]{Lit1, Pair.make(Lit2, Quote.append$V(new Object[]{Lit3, Pair.make(Lit4, Quote.append$V(new Object[]{Lit5, Pair.make(LList.consX(new Object[]{t$Mnname, LList.consX(new Object[]{e$Mnname.toString(), LList.consX(new Object[]{Integer.valueOf(e$Mnval), LList.Empty})})}), LList.Empty)}))}))})})})});
    }
    ...
    static Pair makeValues(Symbol t$Mnarr, LList e$Mnnames) {
        return Pair.make(Lit7, Quote.append$V(new Object[]{Lit8, LList.consX(new Object[]{t$Mnarr, Quote.append$V(new Object[]{Lit9, Pair.make(Lit10, Pair.make(LList.consX(new Object[]{t$Mnarr, Quote.append$V(new Object[]{e$Mnnames, LList.Empty})}), LList.Empty))})})}));
    }

    static Object lambda1(Object form) {
        Object[] objArrAllocVars = SyntaxPattern.allocVars(6, null);
        if (Lit12.match(form, objArrAllocVars, 0) && std_syntax.isIdentifier(Lit13.execute(objArrAllocVars, TemplateScope.make()))) {
            return Lit14.execute(objArrAllocVars, TemplateScope.make());
        }
        if (Lit15.match(form, objArrAllocVars, 0)) {
            return Lit16.execute(objArrAllocVars, TemplateScope.make());
        }
        if (Lit17.match(form, objArrAllocVars, 0)) {
        ...
        if (Lit18.match(form, objArrAllocVars, 0)) {
        ...
        return Lit19.match(form, objArrAllocVars, 0) ? Lit20.execute(objArrAllocVars, TemplateScope.make()) : syntax_case.error("syntax-case", form);
    }

    static LList mapNames(Symbol t$Mnname, LList e$Mnnames, int i) throws Throwable {
        if (lists.isNull(e$Mnnames)) {
            return LList.Empty;
        }
        Object objApply1 = lists.car.apply1(e$Mnnames);
        try {
            Object objMakeFieldDesc = makeFieldDesc(t$Mnname, (Symbol) objApply1, i);
            Object objApply12 = lists.cdr.apply1(e$Mnnames);
            try {
                return lists.cons(objMakeFieldDesc, mapNames(t$Mnname, (LList) objApply12, i + 1));
            } catch (ClassCastException e) {
                throw new WrongType(e, "map-names", 1, objApply12);
            }
        } catch (ClassCastException e2) {
            throw new WrongType(e2, "make-field-desc", 1, objApply1);
        }
    }

    static Object lambda2(Object form) throws Throwable {
        Object[] objArrAllocVars = SyntaxPattern.allocVars(5, null);
        if (!Lit22.match(form, objArrAllocVars, 0)) {
            return syntax_case.error("syntax-case", form);
        }
        Object objExecute = Lit23.execute(objArrAllocVars, TemplateScope.make());
        try {
            Symbol t$Mnname = (Symbol) objExecute;
            Symbol t$Mnarr = symbolAppend$V(new Object[]{t$Mnname, Lit24});
            Object objExecute2 = Lit25.execute(objArrAllocVars, TemplateScope.make());
            try {
                LList e$Mnnames = (LList) objExecute2;
                ...
                Object objExecute3 = Lit26.execute(objArrAllocVars, TemplateScope.make());
                try {
                    LList opts = (LList) objExecute3;
                    Object objExecute4 = Lit27.execute(objArrAllocVars, TemplateScope.make());
                    try {
                        LList other$Mndefs = (LList) objExecute4;
                        TemplateScope templateScopeMake = TemplateScope.make();
                        return Quote.append$V(new Object[]{Lit28.execute(objArrAllocVars, templateScopeMake), LList.consX(new Object[]{SyntaxForms.makeWithTemplate(form, t$Mnname), Pair.make(Lit29.execute(objArrAllocVars, templateScopeMake), Quote.append$V(new Object[]{Lit30.execute(objArrAllocVars, templateScopeMake), Pair.make(Lit31.execute(objArrAllocVars, templateScopeMake), Quote.append$V(new Object[]{SyntaxForms.makeWithTemplate(form, opts), LList.consX(new Object[]{SyntaxForms.makeWithTemplate(form, init), LList.consX(new Object[]{SyntaxForms.makeWithTemplate(form, values$Mnmethod), Pair.make(Pair.make(Lit32.execute(objArrAllocVars, templateScopeMake), Quote.append$V(new Object[]{Lit33.execute(objArrAllocVars, templateScopeMake), LList.consX(new Object[]{SyntaxForms.makeWithTemplate(form, t$Mnname), Quote.append$V(new Object[]{Lit34.execute(objArrAllocVars, templateScopeMake), Pair.make(Lit35.execute(objArrAllocVars, templateScopeMake), Pair.make(Pair.make(Lit36.execute(objArrAllocVars, templateScopeMake), LList.consX(new Object[]{SyntaxForms.makeWithTemplate(form, t$Mnname), Lit37.execute(objArrAllocVars, templateScopeMake)})), Lit38.execute(objArrAllocVars, templateScopeMake)))})})})), Quote.append$V(new Object[]{SyntaxForms.makeWithTemplate(form, field$Mndescs), Quote.append$V(new Object[]{SyntaxForms.makeWithTemplate(form, other$Mndefs), Lit39.execute(objArrAllocVars, templateScopeMake)})}))})})}))}))})});
                    } catch (ClassCastException e) {
                        throw new WrongType(e, "other-defs", -2, objExecute4);
                    }
                } catch (ClassCastException e2) {
                    throw new WrongType(e2, "opts", -2, objExecute3);
                }
            } catch (ClassCastException e3) {
                throw new WrongType(e3, "e-names", -2, objExecute2);
            }
        } catch (ClassCastException e4) {
            throw new WrongType(e4, "t-name", -2, objExecute);
        }
    }
}
