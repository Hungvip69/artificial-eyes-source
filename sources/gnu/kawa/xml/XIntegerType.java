...
public class XIntegerType extends XDataType {
    ...
    public static final XIntegerType longType = new XIntegerType("long", (XDataType) integerType, 8, IntNum.make(Long.MIN_VALUE), IntNum.make(LocationRequestCompat.PASSIVE_INTERVAL));
    ...
    public static final XIntegerType unsignedShortType = new XIntegerType("unsignedShort", (XDataType) unsignedIntType, 15, IntNum.zero(), IntNum.make(SupportMenu.USER_MASK));
