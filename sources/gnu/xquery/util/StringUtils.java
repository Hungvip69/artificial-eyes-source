...
public class StringUtils {
    ...
    public static Object translate(Object str, Object map, Object trans) {
        ...
        Object map2;
        int mi;
        String sv2 = coerceToString(str, "translate", 1, "");
        Object map3 = KNode.atomicValue(map);
        if (!(map3 instanceof UntypedAtomic) && !(map3 instanceof String)) {
            throw new WrongType("translate", 2, str, "xs:string");
        }
        String m = map3.toString();
        int mlen = m.length();
        ...
        while (i2 < slen) {
            int i3 = i2 + 1;
            char c1 = sv2.charAt(i2);
            char c2 = 0;
            if (c1 >= 55296 && c1 < 56320 && i3 < slen) {
                i = i3 + 1;
                c2 = sv2.charAt(i3);
            } else {
                i = i3;
            ...
            if (length >= 0) {
                ...
                if (str.indexOf("{Is") >= 0) {
                    ...
                    while (i < length3) {
                        ...
                        if (cCharAt3 == '\\' && i7 + 4 < length3) {
                            stringBuffer2.append(cCharAt3);
                            i = i7 + 1;
                            char cCharAt4 = str.charAt(i7);
                            stringBuffer2.append(cCharAt4);
                            if (cCharAt4 == 'p' || cCharAt4 == 'P') {
