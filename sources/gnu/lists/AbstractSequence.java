...
public abstract class AbstractSequence {
    ...
    public Object[] toArray(Object[] arr) {
        ...
        int len = size();
        if (len > alen) {
            arr = (Object[]) java.lang.reflect.Array.newInstance(arr.getClass().getComponentType(), len);
            alen = len;
        }
        int it = startPos();
        int i = 0;
