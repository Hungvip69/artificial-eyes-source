...
public class let_syntax extends Syntax {
    ...
    public Expression rewrite(Object obj, Translator tr) {
        ...
        while (i < decl_count) {
            ...
            SyntaxForm listSyntax2 = listSyntax;
            ...
            if ((name instanceof String) || (name instanceof Symbol)) {
                ...
                while (binding_cdr instanceof SyntaxForm) {
                    bindingSyntax2 = (SyntaxForm) binding_cdr;
                ...
                if (bindingSyntax2 != null) {
                    scopeExpCurrentScope = bindingSyntax2.getScope();
                } else {
                    scopeExpCurrentScope = this.recursive ? let : tr.currentScope();
                }
                macro.setCapturedScope(scopeExpCurrentScope);
                decls[i] = decl;
