...
/* JADX INFO: compiled from: system.scm */
/* JADX INFO: loaded from: classes.dex */
public class system extends ModuleBody {

    /* JADX INFO: renamed from: catch, reason: not valid java name */
    public static final ModuleMethod f20catch;
    ...
    static {
        ...
        f20catch = new ModuleMethod(systemVar, 9, Lit10, 12291);
    ...
    public static Process makeProcess(Object args, Object env) throws Throwable {
        Object arargs;
    ...
    public static Object convertVectorToStringArray(Object vec) throws Throwable {
        try {
            ...
            for (Object i = Lit0; Scheme.numEqu.apply2(i, Integer.valueOf(count)) == Boolean.FALSE; i = AddOp.$Pl.apply2(i, Lit1)) {
                ...
                try {
                    try {
                        Object objVectorRef = vectors.vectorRef((FVector) vec, ((Number) i).intValue());
                        arr[iIntValue] = objVectorRef == null ? null : objVectorRef.toString();
                    } catch (ClassCastException e) {
    ...
    public static Object tokenizeStringToStringArray(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            cdr = lists.cons(stringTokenizer.nextToken(), cdr);
        }
        try {
            int length = lists.length((LList) cdr);
            String[] strArr = new String[length];
            int i = length - 1;
            while (!lists.isNull(cdr)) {
                try {
                    Pair pair = (Pair) cdr;
                    ...
                    throw new WrongType(e, "pp", -2, cdr);
                }
            }
            return strArr;
        } catch (ClassCastException e2) {
            throw new WrongType(e2, PropertyTypeConstants.PROPERTY_TYPE_LENGTH, 1, cdr);
        }
    }
    ...
    public static void compileFile(CharSequence source, String output) throws SyntaxException, IOException {
    ...
    @Override // gnu.expr.ModuleBody
    public Object apply2(ModuleMethod moduleMethod, Object obj, Object obj2) throws SyntaxException, IOException {
        switch (moduleMethod.selector) {
            case 1:
    ...
    /* JADX INFO: renamed from: catch, reason: not valid java name */
    public static Object m640catch(Object key, Procedure thunk, Procedure handler) {
        try {
            return thunk.apply0();
    ...
    public Object apply3(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3) {
        ...
        try {
            try {
                return m640catch(obj, (Procedure) obj2, (Procedure) obj3);
            } catch (ClassCastException e) {
