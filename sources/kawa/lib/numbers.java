...
/* JADX INFO: compiled from: numbers.scm */
...
public class numbers extends ModuleBody {
    ...
    public static Object divAndMod(RealNum x, RealNum y) throws Throwable {
        Object objApply2 = DivideOp.div.apply2(x, y);
        try {
            RealNum q = LangObjType.coerceRealNum(objApply2);
            Object objApply22 = AddOp.$Mn.apply2(x, MultiplyOp.$St.apply2(q, y));
            try {
                RealNum r = LangObjType.coerceRealNum(objApply22);
                return misc.values(q, r);
            } catch (ClassCastException e) {
                throw new WrongType(e, "r", -2, objApply22);
            }
        } catch (ClassCastException e2) {
            throw new WrongType(e2, "q", -2, objApply2);
        }
    }
    ...
    public static Object div0AndMod0(RealNum x, RealNum y) throws Throwable {
        Object objApply2 = DivideOp.div0.apply2(x, y);
        try {
            RealNum q = LangObjType.coerceRealNum(objApply2);
            Object objApply22 = AddOp.$Mn.apply2(x, MultiplyOp.$St.apply2(q, y));
            try {
