...
/* JADX INFO: compiled from: files.scm */
...
public class files extends ModuleBody {
    ...
    public static void deleteFile(FilePath file) throws IOException {
        if (!file.delete()) {
    ...
    public static void copyFile(Path from, Path to) throws Throwable {
