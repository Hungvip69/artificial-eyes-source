...
/* JADX INFO: compiled from: srfi95.scm */
...
public class srfi95 extends ModuleBody {
    ...
    public static void $PcSortVector(Sequence sequence, Object obj) throws Throwable {
    ...
    public static Object isSorted(Object obj, Object obj2, Object obj3) throws Throwable {
        if (lists.isNull(obj)) {
            return Boolean.TRUE;
        }
        if (obj instanceof Sequence) {
            try {
                ...
                Object objValueOf = Integer.valueOf(size - 1);
                Object objApply2 = Scheme.applyToArgs.apply2(obj3, sequence.get(size));
                while (true) {
                    try {
                        boolean zIsNegative = numbers.isNegative(LangObjType.coerceRealNum(objValueOf));
                        if (zIsNegative) {
                            return zIsNegative ? Boolean.TRUE : Boolean.FALSE;
                        }
                        try {
                            Object objApply22 = Scheme.applyToArgs.apply2(obj3, sequence.get(((Number) objValueOf).intValue()));
                            Object objApply3 = Scheme.applyToArgs.apply3(obj2, objApply22, objApply2);
                            if (objApply3 == Boolean.FALSE) {
                                return objApply3;
                            }
                            objValueOf = AddOp.$Pl.apply2(Lit0, objValueOf);
                            objApply2 = objApply22;
                        } catch (ClassCastException e) {
                            throw new WrongType(e, "gnu.lists.Sequence.get(int)", 2, objValueOf);
                        }
                    } catch (ClassCastException e2) {
                        throw new WrongType(e2, "negative?", 1, objValueOf);
                    }
                }
            ...
            Object objApply23 = Scheme.applyToArgs.apply2(obj3, lists.car.apply1(obj));
            Object objApply1 = lists.cdr.apply1(obj);
            while (true) {
                boolean zIsNull = lists.isNull(objApply1);
                if (zIsNull) {
                    return zIsNull ? Boolean.TRUE : Boolean.FALSE;
                }
                Object objApply24 = Scheme.applyToArgs.apply2(obj3, lists.car.apply1(objApply1));
                Object objApply32 = Scheme.applyToArgs.apply3(obj2, objApply24, objApply23);
                try {
                    int i = ((objApply32 != Boolean.FALSE ? 1 : 0) + 1) & 1;
                    if (i == 0) {
                        return i != 0 ? Boolean.TRUE : Boolean.FALSE;
                    }
                    objApply1 = lists.cdr.apply1(objApply1);
                    objApply23 = objApply24;
                } catch (ClassCastException e4) {
                    throw new WrongType(e4, "x", -2, objApply32);
                }
            }
        }
    }
    ...
    public static Object sort$ClMerge$Ex(Object a, Object b, Object isLess, Object key) throws Throwable {
    ...
    /* JADX WARN: Incorrect condition in loop: B:15:0x0048 */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static java.lang.Object $PcSortList(java.lang.Object r8, java.lang.Object r9, java.lang.Object r10) throws java.lang.Throwable {
        /*
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda2step(Object n) throws Throwable {
            ...
            if (Scheme.numEqu.apply2(n, srfi95.Lit1) != Boolean.FALSE) {
                ...
                if (Scheme.applyToArgs.apply3(this.less$Qu, Scheme.applyToArgs.apply2(this.keyer, y), Scheme.applyToArgs.apply2(this.keyer, x)) != Boolean.FALSE) {
                    try {
                        ((Pair) p).setCar(y);
                        Object objApply1 = lists.cdr.apply1(p);
                        try {
                            ((Pair) objApply1).setCar(x);
                        } catch (ClassCastException e) {
                ...
                Object objApply12 = lists.cdr.apply1(p);
                try {
                    ((Pair) objApply12).setCdr(LList.Empty);
                    return p;
                } catch (ClassCastException e3) {
                    throw new WrongType(e3, "set-cdr!", 1, objApply12);
                }
            }
    ...
    public static Object sort$Ex(Sequence seq, Object less$Qu, Object key) throws Throwable {
        if (lists.isList(seq)) {
    ...
    public static Object $PcVectorSort$Ex(Sequence seq, Object less$Qu, Object key) throws Throwable {
        ...
        while (!lists.isNull(sorted)) {
            ...
            Object objApply1 = lists.cdr.apply1(sorted);
    ...
    public static void $PcSortVector(Sequence seq, Object less$Qu, Object key) throws Throwable {
        int dim = seq.size();
    ...
    public static Object sort(Sequence seq, Object less$Qu, Object key) throws Throwable {
        if (lists.isList(seq)) {
