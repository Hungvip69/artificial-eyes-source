...
/* JADX INFO: compiled from: ports.scm */
...
public class ports extends ModuleBody {
    ...
    public static void forceOutput() throws IOException {
    ...
    public static Object withInputFromFile(Path pathname, Procedure proc) throws IOException {
    ...
    public static Object withOutputToFile(Path path, Procedure proc) throws IOException {
    ...
    public static Object callWithInputString(CharSequence str, Procedure proc) throws Throwable {
    ...
    public static Object callWithOutputString(Procedure proc) throws Throwable {
    ...
    public static void forceOutput(Object port) throws IOException {
        try {
            ((Writer) port).flush();
        } catch (ClassCastException e) {
    ...
    public static Object defaultPrompter(Object port) throws Throwable {
        char state = inputPortReadState(port);
        if (characters.isChar$Eq(Char.make(state), Lit7)) {
            return "";
        }
        Object objStringAppend = characters.isChar$Eq(Char.make(state), Lit8) ? "#|kawa:" : strings.stringAppend("#|", strings.makeString(1, Char.make(state)), "---:");
        Object objApply1 = input$Mnport$Mnline$Mnnumber.apply1(port);
        try {
            return strings.stringAppend(objStringAppend, numbers.number$To$String((Number) objApply1), "|# ");
        } catch (ClassCastException e) {
            throw new WrongType(e, "number->string", 0, objApply1);
        }
    }
    ...
    public static Object read(InPort port) throws SyntaxException, IOException {
    ...
    public static void transcriptOn(Object filename) throws IOException {
        OutPort.setLogFile(filename.toString());
    }

    @Override // gnu.expr.ModuleBody
    public Object apply1(ModuleMethod moduleMethod, Object obj) throws IOException {
        switch (moduleMethod.selector) {
            case 1:
                try {
    ...
    public static void transcriptOff() throws IOException {
        OutPort.closeLogFile();
    }

    @Override // gnu.expr.ModuleBody
    public Object apply0(ModuleMethod moduleMethod) throws IOException {
        switch (moduleMethod.selector) {
            case 15:
