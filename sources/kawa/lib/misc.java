...
/* JADX INFO: compiled from: misc.scm */
...
public class misc extends ModuleBody {
    ...
    static boolean lambda2$V(Symbol symbol, Symbol symbol2, Object[] objArr) {
        ...
        boolean zEquals = Symbol.equals(symbol, symbol2);
        if (!zEquals) {
            return zEquals;
        }
        return Scheme.apply.apply3(symbol$Eq$Qu, symbol2, lListMakeList) != Boolean.FALSE;
    }
    ...
    public static Object dynamicWind(Object before, Object thunk, Object after) throws Throwable {
    ...
    public static Object error$V(Object msg, Object[] argsArray) throws Throwable {
    ...
    public static Object baseUri(Object node) {
        Path pathBaseURI;
        if (node == null) {
            pathBaseURI = Path.currentPath();
        } else {
            pathBaseURI = ((KNode) node).baseURI();
        }
        Path uri = pathBaseURI;
