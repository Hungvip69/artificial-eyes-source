...
/* JADX INFO: compiled from: trace.scm */
...
public class trace extends ModuleBody {
    ...
    public static Object disassemble(Procedure proc) {
        ...
        int iStartFromContext = $ctx.startFromContext();
        try {
            PrimProcedure.disassemble$X(proc, $ctx);
            return $ctx.getFromContext(iStartFromContext);
        } catch (Throwable th) {
            $ctx.cleanupFromContext(iStartFromContext);
            throw th;
        }
    }
