...
/* JADX INFO: compiled from: hashtables.scm */
...
public class hashtables extends ModuleBody {
    ...
    public static void hashtableSet$Ex(hashtable.HashTable ht, Object key, Object value) throws Throwable {
    ...
    public static void hashtableDelete$Ex(hashtable.HashTable ht, Object key) throws Throwable {
        hashtable.hashtableCheckMutable(ht);
        ht.remove(key);
    }
    ...
    public static Object hashtableUpdate$Ex(hashtable.HashTable ht, Object key, Procedure proc, Object obj) throws Throwable {
        hashtable.hashtableCheckMutable(ht);
        HashNode node = ht.getNode(key);
        if (node == null) {
    ...
    public static void hashtableClear$Ex(hashtable.HashTable ht, int k) throws Throwable {
        hashtable.hashtableCheckMutable(ht);
        ht.clear();
    }
    ...
    public static Object hashtableHashFunction(hashtable.HashTable ht) throws Throwable {
