...
/* JADX INFO: compiled from: regex.scm */
...
public class regex extends ModuleBody {
    ...
    public static CharSequence regexReplace(Object re, CharSequence str, Object repl) throws Throwable {
        Pattern rex;
        if (re instanceof Pattern) {
            try {
                rex = (Pattern) re;
        ...
        if (!misc.isProcedure(repl)) {
            if (repl != null) {
                string = repl.toString();
            }
        } else {
            Object objApply2 = Scheme.applyToArgs.apply2(repl, matcher.group());
            string = Matcher.quoteReplacement(objApply2 != null ? objApply2.toString() : null);
        }
    ...
    public class frame extends ModuleBody {
        ...
        public String lambda1loop() throws Throwable {
            if (this.matcher.find()) {
                Matcher matcher = this.matcher;
                StringBuffer stringBuffer = this.sbuf;
                Object objApply2 = Scheme.applyToArgs.apply2(this.repl, this.matcher.group());
                matcher.appendReplacement(stringBuffer, Matcher.quoteReplacement(objApply2 == null ? null : objApply2.toString()));
            }
