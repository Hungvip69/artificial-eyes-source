...
public class SyntaxRules extends Procedure1 implements Printable, Externalizable {
    ...
    public SyntaxRules(Object[] literal_identifiers, Object srules, Translator tr) throws Throwable {
        int rules_count;
        ...
        while (i < rules_count) {
            ...
            while (syntax_rule instanceof SyntaxForm) {
                rule_syntax2 = (SyntaxForm) syntax_rule;
                    ...
                    try {
                        ...
                        try {
                            ...
                            while (pattern instanceof SyntaxForm) {
                                try {
                                    pattern_syntax2 = (SyntaxForm) pattern;
