...
public class CompileFile {
    public static final Compilation read(String name, SourceMessages messages) throws SyntaxException, IOException {
        try {
    ...
    public static final Compilation read(InPort port, SourceMessages messages) throws SyntaxException, IOException {
