...
public class AutoloadProcedure extends Procedure implements Externalizable {
    ...
    void load() throws IllegalAccessException {
        Object mod;
        ...
        try {
            ...
            if (classModuleBody.isAssignableFrom(cls)) {
                ...
                Object mod2 = context.searchInstance(cls);
                if (mod2 == null) {
                    try {
                        mod = cls.getDeclaredField("$instance").get(null);
                ...
                this.loaded = (Procedure) cls.newInstance();
                if (this.loaded == this) {
    ...
    public Procedure getSetter() throws IllegalAccessException {
        if (this.loaded == null) {
            load();
        }
