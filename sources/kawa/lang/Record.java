...
public class Record {
    ...
    public Object get(String fname, Object defaultValue) {
        Class<?> cls = getClass();
        try {
            return getField(cls, fname).get(this);
        } catch (IllegalAccessException e) {
            throw new GenericError("illegal access for field " + fname);
        } catch (NoSuchFieldException e2) {
            throw new GenericError("no such field " + fname + " in " + cls.getName());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        ClassType ctype = (ClassType) Type.make(cls);
        Object value2 = null;
        for (gnu.bytecode.Field fld = ctype.getFields(); fld != null; fld = fld.getNext()) {
