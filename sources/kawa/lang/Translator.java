...
public class Translator extends Compilation {
    ...
    Syntax check_if_Syntax(Declaration decl) throws Throwable {
    ...
    */
    public gnu.expr.Expression rewrite_pair(gnu.lists.Pair r18, boolean r19) throws java.lang.Throwable {
        /*
    ...
    */
    ...
    public Expression rewrite_with_position(Object exp, boolean function, PairWithPosition pair) throws Throwable {
        Expression result;
    ...
    public Object popForms(int i) {
        ...
        if (size == i + 1) {
            objElementAt = this.formStack.elementAt(i);
        } else {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public gnu.lists.LList scanBody(java.lang.Object r10, gnu.expr.ScopeExp r11, boolean r12) {
        /*
