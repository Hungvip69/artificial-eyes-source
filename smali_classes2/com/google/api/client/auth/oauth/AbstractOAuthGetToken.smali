...
.method public final execute()Lcom/google/api/client/auth/oauth/OAuthCredentialsResponse;
    ...
    invoke-virtual {v2, v1}, Lcom/google/api/client/auth/oauth/OAuthParameters;->intercept(Lcom/google/api/client/http/HttpRequest;)V
    ...
    invoke-virtual {v2, v3}, Lcom/google/api/client/http/HttpResponse;->setContentLoggingLimit(I)Lcom/google/api/client/http/HttpResponse;

    .line 75
    new-instance v3, Lcom/google/api/client/auth/oauth/OAuthCredentialsResponse;

    invoke-direct {v3}, Lcom/google/api/client/auth/oauth/OAuthCredentialsResponse;-><init>()V

    .line 76
    .local v3, "oauthResponse":Lcom/google/api/client/auth/oauth/OAuthCredentialsResponse;
    invoke-virtual {v2}, Lcom/google/api/client/http/HttpResponse;->parseAsString()Ljava/lang/String;

    move-result-object v4

    invoke-static {v4, v3}, Lcom/google/api/client/http/UrlEncodedParser;->parse(Ljava/lang/String;Ljava/lang/Object;)V
