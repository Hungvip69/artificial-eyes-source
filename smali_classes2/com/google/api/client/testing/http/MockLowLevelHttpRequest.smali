...
.method public getContentAsString()Ljava/lang/String;
    ...
    .line 160
    invoke-static {v2, v0}, Lcom/google/api/client/util/IOUtils;->copy(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    invoke-direct {v3, v2}, Lcom/google/api/client/http/HttpMediaType;-><init>(Ljava/lang/String;)V
    ...
    .line 165
    .local v3, "mediaType":Lcom/google/api/client/http/HttpMediaType;
    :goto_0
    if-eqz v3, :cond_4

    .line 166
    invoke-virtual {v3}, Lcom/google/api/client/http/HttpMediaType;->getCharsetParameter()Ljava/nio/charset/Charset;
    ...
    :cond_4
    :goto_1
    sget-object v4, Lcom/google/api/client/util/Charsets;->ISO_8859_1:Ljava/nio/charset/Charset;
