...
.method public refresh()Lcom/google/api/client/googleapis/auth/oauth2/GooglePublicKeysManager;
    ...
    .line 179
    .local v3, "currentToken":Lcom/google/api/client/json/JsonToken;
    if-nez v3, :cond_0
    ...
    :goto_0
    invoke-static {v4}, Lcom/google/api/client/util/Preconditions;->checkArgument(Z)V
    :try_end_0
    ...
    .line 191
    :cond_2
    iget-object v4, p0, Lcom/google/api/client/googleapis/auth/oauth2/GooglePublicKeysManager;->publicKeys:Ljava/util/List;

    invoke-static {v4}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v4

    iput-object v4, p0, Lcom/google/api/client/googleapis/auth/oauth2/GooglePublicKeysManager;->publicKeys:Ljava/util/List;
    :try_end_1
    ...
    .line 197
    iget-object v4, p0, Lcom/google/api/client/googleapis/auth/oauth2/GooglePublicKeysManager;->lock:Ljava/util/concurrent/locks/Lock;
    ...
    .end local v2    # "parser":Lcom/google/api/client/json/JsonParser;
    .end local v3    # "currentToken":Lcom/google/api/client/json/JsonToken;
    :catchall_1
    move-exception v0
