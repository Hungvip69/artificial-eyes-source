...
.method public final onNotification(Lcom/google/api/client/googleapis/notifications/StoredChannel;Lcom/google/api/client/googleapis/notifications/UnparsedNotification;)V
    ...
    .line 103
    .local v0, "typedNotification":Lcom/google/api/client/googleapis/notifications/TypedNotification;, "Lcom/google/api/client/googleapis/notifications/TypedNotification<TT;>;"
    ...
    invoke-interface {v4, v5, v2, v3}, Lcom/google/api/client/util/ObjectParser;->parseAndClose(Ljava/io/InputStream;Ljava/nio/charset/Charset;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v4

    .line 107
    invoke-virtual {v0, v4}, Lcom/google/api/client/googleapis/notifications/TypedNotification;->setContent(Ljava/lang/Object;)Lcom/google/api/client/googleapis/notifications/TypedNotification;

    .line 110
    .end local v2    # "charset":Ljava/nio/charset/Charset;
    .end local v3    # "dataClass":Ljava/lang/Class;, "Ljava/lang/Class<TT;>;"
    :cond_0
